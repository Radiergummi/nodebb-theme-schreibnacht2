...
<div class="account">
	...
	<div class="row">
		...
		<div class="col-md-7 user-about">
			<!-- IMPORT partials/profile/fields.tpl -->

			<div class="user-recent-posts" data-nextstart="{nextStart}">
				<div class="topic-row panel panel-default clearfix">
					...
					<div class="panel-body">
						...
						<!-- ENDIF !posts.length -->
						<!-- BEGIN posts -->
						<div class="user-post" data-pid="{posts.pid}">
							<p>
								[[global:posted_in_ago, <a href="{relative_path}/category/{posts.category.slug}"><i class="fa {posts.category.icon}"></i> {posts.category.name}</a>, <time class="timeago" datetime="{posts.relativeTime}"></time>]] &bull;
									<a href="{relative_path}/topic/{posts.topic.slug}/{posts.index}">Lesen</a>
							</p>
						</div>
						<hr/>
						<!-- END posts -->
