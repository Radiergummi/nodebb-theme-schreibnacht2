	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close hidden-xs" style="margin:.4em" data-dismiss="modal" id="chat-close-btn"><span aria-hidden="true"><i class="fa fa-close"></i></span><span class="sr-only">[[global:close]]</span></button>
			...
			<div class="modal-body">
				...
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button id="chat-message-send-btn" class="btn btn-primary" href="#" type="button">Senden</button>
					</span>
				</div>
			</div>
		</div>
