	...
	<div class="<!-- IF allowLocalLogin -->col-md-6<!-- ELSE -->col-md-12<!-- ENDIF allowLocalLogin -->">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<h1>Zum ersten mal im neuen Forum?</h1>
				<p>Dein Konto ist natürlich immer noch da, aus Sicherheitsgründen musst du allerdings dein Passwort einmalig zurücksetzen. <br />
				Klicke dazu hier auf <a id="reset-link" href="{relative_path}/reset">Passwort zurücksetzen</a>. Es wird dir anschließend per
				E-Mail zugestellt.</p>
			</div>
		</div>
	</div>
